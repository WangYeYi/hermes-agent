...
def find_project_root(start: Optional[Path] = None) -> Optional[Path]:
    ...
    Memoised per start-cwd for ``HERMES_PROJECT_ROOT_CACHE_TTL`` seconds (default 30, ``0`` disables): the
    skill index asks this once per skill, so the walk-up repeated N times per scan for an N-skill library.
    """
